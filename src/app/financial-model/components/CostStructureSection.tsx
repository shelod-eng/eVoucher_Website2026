  ...
  const costCategories: CostCategory[] = [
    {
      ...
      icon: 'ServerIcon',
      items: ['Cloud infrastructure', 'Security systems', 'Mobile app development', 'USSD gateway integration']
    },
    {
      id: 2,
      ...
      icon: 'UserGroupIcon',
      items: ['Customer support team', 'Merchant onboarding', 'Training programs', 'Quality assurance']
    },
    {
      id: 3,
      ...
      icon: 'MegaphoneIcon',
      items: ['Community outreach', 'Merchant recruitment', 'Brand campaigns', 'Partnership development']
    },
    {
      id: 4,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Strategic allocation of resources to maximize social impact while maintaining operational excellence. Total annual operational costs: <span className="font-bold text-foreground">{totalCosts}</span>
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {costCategories.map((category) => (
            <div key={category.id} className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-border">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-start space-x-4">
                  <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-3 rounded-lg">
                    <Icon name={category.icon as any} size={24} variant="solid" className="text-primary" />
                  </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {category.items.map((item, index) => (
                  <div key={index} className="flex items-center space-x-2">
                    <Icon name="CheckIcon" size={14} variant="solid" className="text-success flex-shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                <Icon name="ArrowTrendingDownIcon" size={28} variant="solid" className="text-primary" />
              </div>
