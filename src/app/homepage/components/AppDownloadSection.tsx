      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {/* Placeholder for iOS to match the Clicks/Professional look */}
            <div className="flex items-center justify-center gap-4 px-7 py-3 bg-white border border-slate-200 text-slate-400 rounded-xl font-semibold cursor-not-allowed grayscale">
              ...
              <div className="text-left">
                <div className="text-[11px] uppercase tracking-wider opacity-80 font-bold leading-tight">Coming soon</div>
