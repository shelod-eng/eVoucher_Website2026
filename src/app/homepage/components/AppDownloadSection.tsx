          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base font-normal text-[#4A4A4A] leading-relaxed max-w-lg">
                Experience the full power of South Africa&apos;s digital voucher infrastructure on your mobile device. 
                Secure, lightweight, and optimized for low-bandwidth environments.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4 border-t border-slate-100">
              {['POPIA', 'SARB', 'FIC'].map((acronym) => (
                <div key={acronym} className="flex items-center space-x-2">
                  ...
                  <span className="text-[11px] font-bold text-[#0A1F44] tracking-widest uppercase">{acronym}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-[10px] uppercase tracking-wider opacity-80 font-bold leading-tight">Get it for</div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-center gap-4 px-6 py-4 bg-white border border-slate-200 text-[#0A1F44] rounded-xl font-semibold shadow-sm transition-colors">
                  ...
                  <div className="text-left">
                    <div className="text-[10px] uppercase tracking-wider opacity-60 font-bold leading-tight">Install for</div>
