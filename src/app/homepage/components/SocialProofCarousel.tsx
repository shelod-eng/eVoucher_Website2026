...
const SocialProofCarousel = () => {
  ...
  const testimonials: Testimonial[] = [
  {
    ...
    quote: 'eVoucher has changed my life. I save R800 every month on groceries, which means my children can have better meals. The USSD system is so easy - I don\'t need a smartphone.',
  ...
  },
  {
    ...
    quote: 'Since joining eVoucher, my customer base has grown by 40%. The platform handles loyalty for me, and I get paid quickly. It\'s helping my business thrive in the township.',
  ...
  },
  {
    ...
    quote: 'eVoucher provides the transparency and accountability we need for social programs. Real-time impact tracking and fraud prevention give us confidence in every rand spent.',
  ...
  },
  {
    ...
    quote: 'I can now afford nutritious food for my family while saving for emergencies. The dignity of choosing what I buy, when I buy it, makes all the difference.',
  ...
  },
  {
    ...
    quote: 'The eVoucher system brought new customers to my butchery. Fast settlements mean I can restock quickly. My business has never been better.',
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto">
            Hear from consumers, merchants, and government partners experiencing the transformative power of eVoucher.
          </p>
        </div>
            ...
            <div className="grid lg:grid-cols-5 gap-0">
              ...
              <div className="lg:col-span-2 relative h-64 lg:h-auto">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <span className={`inline-block px-4 py-2 rounded-full text-sm font-body font-medium ${stakeholderColors[currentTestimonial.stakeholder]}`}>
              ...
              <div className="lg:col-span-3 p-8 lg:p-12 flex flex-col justify-between">
                <div>
                  <Icon name="ChatBubbleLeftRightIcon" size={48} variant="solid" className="text-primary mb-6" />
