        ...
        <div className="pt-24 pb-16 px-4">
          <div className="max-w-md mx-auto">
            <div className="bg-card rounded-2xl shadow-2xl p-12 border-2 border-success text-center">
              ...
              <h1 className="font-headline font-bold text-3xl text-foreground mb-4">Welcome to eVoucher!</h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div>
                <h1 className="font-headline font-bold text-5xl text-foreground mb-4">Register as a Customer</h1>
                <p className="font-body text-xl text-muted-foreground leading-relaxed">
                  Join thousands of South Africans saving money with dignity. No barriers, no judgment, just real savings.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="font-headline font-semibold text-xl text-foreground">What You Get:</h3>
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-headline font-semibold text-foreground">10-15% Savings</h4>
                      <p className="font-body text-sm text-muted-foreground">Real discounts at trusted merchants</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="bg-success/10 p-2 rounded-lg flex-shrink-0">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-headline font-semibold text-foreground">Community Support</h4>
                      <p className="font-body text-sm text-muted-foreground">Help from real people who care</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-card rounded-2xl shadow-2xl p-8 border-2 border-border">
              <div className="text-center mb-8">
                ...
                <h2 className="font-headline font-bold text-2xl text-foreground mb-2">Create Your Account</h2>
                <p className="text-muted-foreground font-body">Quick and easy - takes less than 2 minutes</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="idNumber" className="block text-sm font-headline font-semibold text-foreground mb-2">
              ...
              <div className="mt-6 text-center">
                <Link href="/support" className="inline-flex items-center space-x-2 text-sm text-muted-foreground hover:text-primary transition-colors">
