          ...
          <div>
            <Link href="/homepage" className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="font-headline font-bold text-lg text-background leading-tight">eVoucher</span>
                <span className="font-body text-xs text-background/70 leading-tight">Dignified Impact</span>
              </div>
            </Link>
            ...
            <div className="flex items-center space-x-4">
              <a href="#" className="w-10 h-10 bg-background/10 rounded-full flex items-center justify-center hover:bg-primary transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks?.platform?.map((link, index) => (
                <li key={index}>
                  <Link href={link?.href} className="text-sm text-background/70 hover:text-primary transition-colors duration-300">
                    {link?.label}
                  </Link>
                </li>
              ))}
