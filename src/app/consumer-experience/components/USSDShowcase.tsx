...
const USSDShowcase = () => {
  ...
  },
  {
    ...
    description: 'USSD works without data connection. Perfect for areas with limited connectivity.'
  },
  {
    icon: 'BanknotesIcon',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-secondary/10 rounded-full">
              ...
              <span className="text-sm font-headline font-semibold text-secondary">Universal Access</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Access the full eVoucher platform using USSD technology. Browse vouchers, make purchases, and track savings—all from your basic mobile phone.
            </p>
              ...
              <div className="space-y-3">
                ...
                <div key={index} className="flex items-center space-x-4 p-3 bg-muted rounded-lg">
                    <div className="flex-shrink-0 w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center">
                      <span className="font-headline font-bold text-sm text-primary">{index + 1}</span>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div key={index} className="flex items-start space-x-3 p-4 bg-card rounded-lg shadow-sm">
                  <div className="flex-shrink-0 w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                    <Icon name={feature.icon as any} size={20} variant="solid" className="text-accent" />
                  </div>
                  <div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-card/95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl max-w-sm">
                  <div className="bg-foreground text-background rounded-lg p-6 font-mono text-sm space-y-2">
                    ...
                    <p>5. Help & Support</p>
                    <p className="border-t border-background/20 pt-2 text-center">Reply with option</p>
                  </div>
