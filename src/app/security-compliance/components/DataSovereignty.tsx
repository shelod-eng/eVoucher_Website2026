  ...
  const dataProtectionPrinciples: DataProtectionPrinciple[] = [
    {
      ...
      description: "All personal and financial data stored exclusively within South African borders",
      icon: "GlobeAltIcon",
      implementation: [
    ...
    },
    {
      ...
      description: "Comprehensive data subject rights enabling user control over personal information",
      icon: "HandRaisedIcon",
      implementation: [
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {dataProtectionPrinciples.map((principle) => (
            <div key={principle.id} className="bg-card rounded-lg shadow-md p-6 border border-border">
              <div className="flex items-start space-x-4 mb-4">
                <div className="flex-shrink-0 w-14 h-14 bg-primary/10 rounded-lg flex items-center justify-center">
                  <Icon name={principle.icon as any} size={28} variant="outline" className="text-primary" />
                </div>
              ...
              <div className="mt-4">
                <h4 className="font-body font-semibold text-sm text-foreground mb-3">Implementation:</h4>
                <ul className="space-y-2">
                  {principle.implementation.map((item, index) => (
                    <li key={index} className="flex items-start space-x-2">
                      <Icon name="CheckCircleIcon" size={14} variant="solid" className="text-success mt-0.5 flex-shrink-0" />
          ...
          <div className="p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-1 ml-7">
                    <li className="font-body text-sm text-muted-foreground">• Tier III certified facility</li>
                    <li className="font-body text-sm text-muted-foreground">• 99.98% uptime guarantee</li>
                    <li className="font-body text-sm text-muted-foreground">• 24/7 physical security</li>
                    <li className="font-body text-sm text-muted-foreground">• Redundant power and cooling</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-1 ml-7">
                    <li className="font-body text-sm text-muted-foreground">• Disaster recovery site</li>
                    <li className="font-body text-sm text-muted-foreground">• Real-time data replication</li>
                    <li className="font-body text-sm text-muted-foreground">• Geographic redundancy</li>
                    <li className="font-body text-sm text-muted-foreground">• Automated failover capability</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-body font-semibold text-base text-foreground mb-2 flex items-center space-x-2">
                    <Icon name="ShieldCheckIcon" size={18} variant="outline" className="text-success" />
                    <span>Security Measures</span>
                  </h4>
                  <ul className="space-y-1 ml-7">
                    <li className="font-body text-sm text-muted-foreground">• Biometric access controls</li>
                    <li className="font-body text-sm text-muted-foreground">• CCTV surveillance</li>
                    <li className="font-body text-sm text-muted-foreground">• Environmental monitoring</li>
                    <li className="font-body text-sm text-muted-foreground">• Fire suppression systems</li>
                  </ul>
                </div>

                <div>
                  <h4 className="font-body font-semibold text-base text-foreground mb-2 flex items-center space-x-2">
                    <Icon name="DocumentCheckIcon" size={18} variant="outline" className="text-accent" />
                    <span>Compliance Certifications</span>
                  </h4>
                  <ul className="space-y-1 ml-7">
                    <li className="font-body text-sm text-muted-foreground">• ISO 27001 certified</li>
                    <li className="font-body text-sm text-muted-foreground">• SOC 2 Type II compliant</li>
                    <li className="font-body text-sm text-muted-foreground">• PCI DSS Level 1</li>
                    <li className="font-body text-sm text-muted-foreground">• POPIA compliant infrastructure</li>
                  </ul>
                </div>
              </div>
            </div>
