              ...
              <div key={measure.id} className="bg-card rounded-lg shadow-md p-6 border border-border hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-accent/10 rounded-lg flex items-center justify-center">
                    <Icon name={measure.icon as any} size={24} variant="outline" className="text-accent" />
                  </div>
                  <div className="flex-1">
                    ...
                    <div className="inline-flex items-center space-x-2 px-3 py-1 bg-primary/10 rounded-full">
                      ...
                      <span className="font-body text-xs font-medium text-primary">{measure.frequency}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div>
          ...
          <div className="space-y-6">
            {auditReports.map((report) => (
              <div key={report.id} className="bg-card rounded-lg shadow-md border border-border overflow-hidden">
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-4">
                    <div>
                      <h5 className="font-body font-semibold text-sm text-foreground mb-1">Audit Scope:</h5>
                      <p className="font-body text-sm text-muted-foreground">{report.scope}</p>
                    </div>
                    <div>
                      <h5 className="font-body font-semibold text-sm text-foreground mb-1">Key Findings:</h5>
