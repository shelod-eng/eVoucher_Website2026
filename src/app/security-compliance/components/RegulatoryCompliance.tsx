  ...
  const complianceFrameworks: ComplianceFramework[] = [
    {
      ...
      acronym: "POPIA",
      description: "Comprehensive data protection and privacy compliance ensuring lawful processing of personal information",
    ...
    },
    {
      ...
      acronym: "PASA",
      description: "Payment system standards compliance for secure and efficient electronic payment processing",
      icon: "CreditCardIcon",
    ...
    },
    {
      ...
      acronym: "SARB",
      description: "Central bank regulatory alignment for financial system stability and payment system oversight",
    ...
    },
    {
      ...
      acronym: "FIC",
      description: "Anti-money laundering and counter-terrorism financing compliance for financial crime prevention",
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        ...
        <div className="space-y-6">
          {complianceFrameworks.map((framework) => (
            <div key={framework.id} className="bg-card rounded-lg shadow-md border border-border overflow-hidden">
              <div className="p-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start space-x-4 mb-4">
                      <div className="flex-shrink-0 w-14 h-14 bg-primary/10 rounded-lg flex items-center justify-center">
                        <Icon name={framework.icon as any} size={28} variant="solid" className="text-primary" />
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="font-body text-sm text-foreground">
                          <span className="font-medium">Certified:</span> {framework.certificationDate}
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
                    ...
                    >
                      ...
                      <span className="font-body text-sm font-medium">View Certification Documentation</span>
