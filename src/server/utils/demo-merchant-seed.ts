...
> = {
  ...
  shoprite: [
    ...
    { name: 'Shoprite Monthly Pantry Saver', faceValue: 500 },
    { name: 'Shoprite White Bread 700g', faceValue: 18.99 },
    { name: 'Shoprite Brown Bread 700g', faceValue: 16.99 },
    { name: 'Shoprite Full Cream Milk 2L', faceValue: 32.99 },
    { name: 'Shoprite Maize Meal 5kg', faceValue: 74.99 },
    { name: 'Shoprite Large Eggs 6-Pack', faceValue: 42.99 },
    { name: 'Shoprite Chicken Portions 2kg', faceValue: 89.99 },
    { name: 'Shoprite Sunflower Oil 2L', faceValue: 69.99 },
    { name: 'Shoprite Sugar 2.5kg', faceValue: 54.99 },
    { name: 'Shoprite Rice 2kg', faceValue: 39.99 },
  ],
  engen: [
  ...
  picknpay: [
    ...
    { name: 'Pick n Pay No Name Long Life Milk 6 x 1L', faceValue: 79.99 },
